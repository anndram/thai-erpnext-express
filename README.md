...
Thai Express management module for ERPNext.
...
```
bench get-app https://github.com/anndram/thai-erpnext-express
```

3. Install plugin on your site

```
bench --site [sitename] install-app thai_express
```
...
```
cd ~/frappe-bench/apps/thai_express
```
...
```
bench --site [sitename] uninstall-app thai_express
```

3. (Optional) Remove plugin from bench

```
bench remove-app thai_express
```
...
### License
This repository has been released under the [MIT License](https://github.com/anndram/thai-erpnext-express/blob/main/LICENSE).